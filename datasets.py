...
#         if self.train is True:
#             celeba_dataobj = CelebA(self.root, 'train', 'attr', self.transform, self.target_transform, self.download)
#         else:
#             celeba_dataobj = CelebA(self.root, 'test', self.transform, self.target_transform, self.download)
#
#         data = celeba_dataobj.data
#         target = celeba_dataobj.labels
#
#         if self.dataidxs is not None:
#             data = data[self.dataidxs]
#             target = target[self.dataidxs]
